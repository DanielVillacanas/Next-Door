...
import { UsersIcon, GlobeAltIcon, LightningBoltIcon, ScaleIcon } from "@heroicons/react/outline";
          ...
          <div className="mx-auto max-w-7xl w-full lg:pt-16 pb-20 text-center lg:py-48 lg:text-left">
            <div className="px-4 lg:w-1/2 sm:px-8 xl:pr-16">
              ...
              <p className="mt-3 max-w-md mx-auto text-lg text-white sm:text-xl md:mt-5 md:max-w-3xl">
                Adquiere los productos más naturales en menos de dos días en la puerta de tu casa o
                únete a nosotros como vendedor.
              </p>
            ...
            <blockquote className="mt-6 md:flex-grow md:flex md:flex-col">
              ...
              <footer className="mt-8">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <div className="text-base font-medium text-white">Daniel Villacañas</div>
          ...
          <div className="py-12 px-4 border-t-2 border-green-900 sm:px-6 md:py-16 md:pr-0 md:pl-10 md:border-t-0 md:border-l lg:pl-16">
            ...
            <blockquote className="mt-6 md:flex-grow md:flex md:flex-col">
              <div className="relative text-lg font-medium text-white md:flex-grow">
                ...
                <p className="relative">
                  Nos juntamos, decidimos la idea que queríamos hacer y nos pusímos a ello. Ahora,
                  muchos de nuestros clientes nos escriben para agradecernos la iniciativa, y esto
              ...
              <footer className="mt-8">
                <div className="flex items-start">
                  <div className="flex-shrink-0 inline-flex rounded-full border-2 border-white">
                    <img className="h-12 w-12 rounded-full" src={Alvaro} alt="" />
                  </div>
                  <div className="ml-4">
                    <div className="text-base font-medium text-white">Álvaro Terán</div>
                    <div className="text-base font-medium text-green-200">
                      CEO & Co-Founder, NextDoor
                    </div>
                  </div>
