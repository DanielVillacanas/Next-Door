            ...
            <blockquote className="mt-6 md:flex-grow md:flex md:flex-col">
              <div className="relative text-lg font-medium text-white md:flex-grow">
                ...
                <p className="relative">
                  Este proyecto empezó como un proyecto en Ironhack, a día de
                  hoy,ya ayudamos a más de 500 vendedores. Este es el inicio de
                  una nueva generación para el comércio de cercanía.
                </p>
              </div>
